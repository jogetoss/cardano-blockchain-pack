...
public class PluginUtil {
    ...
    public static String readGenericBackendConfigs(String className) {
        final String configExistResource = AppUtil.readPluginResource(className, "/properties/backendConfigAlreadyExists.json");
        
        return BackendUtil.getBackendDefaultConfig() != null ? configExistResource : forceReadGenericBackendConfigs(className);
    }
