...
public class TempWorkaroundUtxoSelectionStrategyImpl implements UtxoSelectionStrategy {

    private UtxoService utxoService;

    public TempWorkaroundUtxoSelectionStrategyImpl(UtxoService utxoService) {
